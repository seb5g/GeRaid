 ...
 *
 */
public class IhmBaliseDelete extends JDialog
{
   ...
   * @param owner
   */
  public IhmBaliseDelete(IhmGeRaidMain owner, String message)
  {
    super(owner);
    this.owner = owner;
  ...
  private JButton getJButtonOk()
  {
    if (jButtonOk == null)
    {
      ...
      jButtonOk.setToolTipText("Suppression de la balise");
      jButtonOk.setIcon(new ImageIcon(getClass().getResource("/icones/ok64.png")));
      jButtonOk.addActionListener(new java.awt.event.ActionListener()
      {
        public void actionPerformed(java.awt.event.ActionEvent e)
        {
          ((Epreuve)owner.jListEpreuves.getSelectedValue()).getBalises().removeBalise((Balise)owner.jListBalises.getSelectedValue());
          owner.jListBalises.repaint();
          if(((Epreuve)owner.jListEpreuves.getSelectedValue()).getBalises().getSize()==0)
          {
            owner.jListBalises.setSelectedIndex(-1);
          }
          else
          {
            owner.jListBalises.setSelectedIndex(0);
          }
          dispose();
        }
      });
