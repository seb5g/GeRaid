 ...
 *
 */
public class IhmPartielDelete extends JDialog
{
   ...
   * @param owner
   */
  public IhmPartielDelete(IhmGestionResultatPuce owner, String message)
  {
    super(owner);
    this.owner = owner;
  ...
  private JButton getJButtonOk()
  {
    if (jButtonOk == null)
    {
      ...
      jButtonOk.addActionListener(new java.awt.event.ActionListener()
      {
        ...
        {
          owner.resultatCourant.getPuce().removePartiel((Partiel) owner.jListPostes.getSelectedValue());
          dispose();
        }
      });
    }
