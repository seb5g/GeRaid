 ...
 *
 */
public class EtapeTableModel extends AbstractTableModel implements Printable
{
  /**
   * 
   */
      ...
      throws PrinterException
  {
    ...
    switch(pageIndex)
    {
      case 0 : 
      {
        ...
        index = index + size;
        graphics.drawString("Parcours : " + resultatEtape.getGeRaid().getParcours(resultatEtape.getEtape()).getNom(), marge, index);
        index = index + size;
