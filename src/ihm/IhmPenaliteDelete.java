 ...
 *
 */
public class IhmPenaliteDelete extends JDialog
{
   ...
   * @param owner
   */
  public IhmPenaliteDelete(IhmPenalite owner, String message, Penalite p)
  {
    super(owner);
    this.owner = owner;
  ...
  private JButton getJButtonOk()
  {
    if (jButtonOk == null)
    {
      ...
      jButtonOk.setToolTipText("Supprimer la pénalité");
      jButtonOk.setIcon(new ImageIcon(getClass().getResource("/icones/ok64.png")));
      jButtonOk.addActionListener(new java.awt.event.ActionListener()
      {
        public void actionPerformed(java.awt.event.ActionEvent e)
        {
          owner.geraid.penalites.getPenalites().remove(penalite);
          dispose();
        }
      });
    }
