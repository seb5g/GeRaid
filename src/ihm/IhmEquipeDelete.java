 ...
 *
 */
public class IhmEquipeDelete extends JDialog
{
   ...
   * @param owner
   */
  public IhmEquipeDelete(IhmGeRaidMain owner, String message)
  {
    super(owner);
    this.owner = owner;
  ...
  private JButton getJButtonOk()
  {
    if (jButtonOk == null)
    {
      ...
      jButtonOk.setToolTipText("Supprimer l'équipe");
      jButtonOk.setIcon(new ImageIcon(getClass().getResource("/icones/ok64.png")));
      jButtonOk.addActionListener(new java.awt.event.ActionListener()
      {
        public void actionPerformed(java.awt.event.ActionEvent e)
        {
          owner.geRaid.removeEquipe(((Parcours)owner.jComboBoxParcours.getSelectedItem()).getEquipes(), (Equipe)owner.jListEquipes.getSelectedValue());
          owner.jListEquipes.repaint();
          if(((Parcours)owner.jComboBoxParcours.getSelectedItem()).getEquipes().getSize()==0)
          {
