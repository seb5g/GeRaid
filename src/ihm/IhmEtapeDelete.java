 ...
 *
 */
public class IhmEtapeDelete extends JDialog
{
   ...
   * @param owner
   */
  public IhmEtapeDelete(IhmGeRaidMain owner, String message)
  {
    super(owner);
    this.owner = owner;
  ...
  private JButton getJButtonOk()
  {
    if (jButtonOk == null)
    {
      ...
      jButtonOk.setToolTipText("Supprimer l'étape");
      jButtonOk.setIcon(new ImageIcon(getClass().getResource("/icones/ok64.png")));
      jButtonOk.addActionListener(new java.awt.event.ActionListener()
      {
        public void actionPerformed(java.awt.event.ActionEvent e)
        {
          Etape et = (Etape)owner.jComboBoxEtapes.getSelectedItem();
          ((Parcours)owner.jComboBoxParcours.getSelectedItem()).getEtapes().removeEtape(et);
          owner.geRaid.getResultatsPuce().effacerEtape(et);
          owner.geRaid.penalites.effacerEtape(et);
          owner.jComboBoxEtapes.repaint();
          if(((Parcours)owner.jComboBoxParcours.getSelectedItem()).getEtapes().getSize()==0)
          {
            owner.jComboBoxEtapes.setSelectedIndex(-1);
          }
          else
          {
            owner.jComboBoxEtapes.setSelectedIndex(0);
          }
          dispose();
        }
      });
